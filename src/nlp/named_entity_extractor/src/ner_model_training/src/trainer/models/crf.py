...
class CRF(Layer):
    # NOTE: code is copied with slight modifications
    # from https://github.com/keras-team/keras-contrib/blob/master/keras_contrib/layers/crf.py
    # because keras_contrib is deprecated
